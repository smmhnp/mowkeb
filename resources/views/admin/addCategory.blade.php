    ...
    @endif
        ...
        <main class="main-content">
            ...
            <div class="article-form">
                <form id="new-article-form" action="{{ route('CategoryController.CategoryStoreManager') }}" method="post">
                    @csrf

                    <div class="form-row">
                        <div class="form-group">
                            <label for="name">عنوان دسته بندی <span class="required">*</span></label>
                            <input name="name" type="text" id="name" class="form-control" placeholder="عنوان را وارد کنید" required>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea name="content" class="form-control" rows="10" id="content" placeholder="متن کامل دسته بندی را اینجا بنویسید..."></textarea>
                        </div>
                    </div>                    
